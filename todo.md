Suggested TODO list (paste into your coding agent)
 ...
 P2: Mirror MARKDOWNEDITOR_HAVE_SONNET / KF6::Sonnet* onto the test_core target (conditionally, when KF6Sonnet_FOUND) so the Sonnet-enabled code path is actually covered by CI.
